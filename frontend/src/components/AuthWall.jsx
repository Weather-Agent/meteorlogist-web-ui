    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen animated-bg text-white px-4">
        ...
        <div className="text-center mb-8 max-w-md w-full z-10">
          <h1 className="text-4xl sm:text-5xl font-bold mb-2 text-blue-300">
            Meghdoot AI
          </h1>
          <p className="text-base sm:text-xl text-slate-300">
            Your advanced weather tracking and visualization platform
          </p>
        </div>
        ...
        <div className="w-full max-w-md auth-card rounded-xl p-6 sm:p-8 z-10">
          ...
          <p className="text-slate-400 text-sm sm:text-base mb-5 sm:mb-6 text-center">
            Please sign in to access your personalized weather dashboard and
            emergency alerts.
          </p>
          ...
          >
            ...
            >
              <path
                fillRule="evenodd"
                d="M10 0C4.477 0 0 4.477 0 10c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0110 4.836c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.917.678 1.846 0 1.334-.012 2.41-.012 2.737 0 .267.18.578.688.48C17.137 18.163 20 14.418 20 10c0-5.522-4.478-10-10-10z"
                clipRule="evenodd"
              />
            </svg>
            Sign In with Civic
